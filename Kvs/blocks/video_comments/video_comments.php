...
function video_commentsShow($block_config,$object_id)
{
	...
	} elseif ($video_info['is_private']==1)
	{
		if (intval($memberzone_data['ENABLE_TOKENS_PRIVATE_VIDEO'])==1)
		{
			if (intval($video_info['tokens_required'])==0)
			{
				$video_info['tokens_required']=intval($memberzone_data['DEFAULT_TOKENS_PRIVATE_VIDEO']);
			}
		} else {
			$video_info['tokens_required']=0;
		}
		...
		if (intval($memberzone_data['ENABLE_TOKENS_PUBLIC_VIDEO'])==1)
		{
			if (intval($video_info['tokens_required'])==0)
			{
				$video_info['tokens_required']=intval($memberzone_data['DEFAULT_TOKENS_PUBLIC_VIDEO']);
			}
		} else {
			$video_info['tokens_required']=0;
		}
