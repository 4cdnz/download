	...
	<form action="{{$page_name}}" method="get" class="form_dgf" name="{{$smarty.now}}">
		<div class="dgf">
			<div class="dgf_filter">
				<div class="drop">
					<i class="icon icon-action-groupby"></i><span>{{$lang.stats.albums_filter_group_by}}</span>
					<ul>
						<li {{if $smarty.session.save.$page_name.se_group_by=='date'}}class="selected"{{/if}}><a href="{{$page_name}}?se_group_by=date">{{$lang.stats.albums_filter_group_by_date}}</a></li>
						<li {{if $smarty.session.save.$page_name.se_group_by=='album'}}class="selected"{{/if}}><a href="{{$page_name}}?se_group_by=album">{{$lang.stats.albums_filter_group_by_album}}</a></li>
						<li {{if $smarty.session.save.$page_name.se_group_by=='content_source'}}class="selected"{{/if}}><a href="{{$page_name}}?se_group_by=content_source">{{$lang.stats.albums_filter_group_by_content_source}}</a></li>
						<li {{if $smarty.session.save.$page_name.se_group_by=='user'}}class="selected"{{/if}}><a href="{{$page_name}}?se_group_by=user">{{$lang.stats.albums_filter_group_by_user}}</a></li>
					</ul>
				</div>
			</div>
			<div class="dgf_reset">
		...
		<div class="dgf_advanced">
			...
			<div class="dgf_advanced_filters">
				<div class="dgf_filter">
					<input type="text" name="se_id" value="{{$smarty.session.save.$page_name.se_id}}" placeholder="{{$lang.stats.albums_field_id}}..."/>
				</div>
				<div class="dgf_filter">
					<select name="se_storage_group_id">
						<option value="">{{$lang.stats.albums_field_storage_group}}...</option>
				...
				<div class="dgf_filter">
					<div class="insight">
						...
						<input type="text" name="se_content_source" value="{{$smarty.session.save.$page_name.se_content_source}}" placeholder="{{$lang.stats.albums_field_content_source}}..."/>
					</div>
				</div>
				<div class="dgf_filter">
					<div class="insight">
						...
						<input type="text" name="se_user" value="{{$smarty.session.save.$page_name.se_user}}" placeholder="{{$lang.stats.albums_field_user}}..."/>
					</div>
				</div>
		...
		<div class="dgb">
			<div class="dgb_actions">
				<select name="batch_action">
					...
					{{if $can_edit_all==1 && $smarty.session.save.$page_name.se_group_by=='album'}}
						<option value="mass_select">{{$lang.stats.albums_batch_action_mass_select|replace:"%1%":'${count}'}}</option>
					{{/if}}
				</select>
