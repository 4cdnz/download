...
<form action="{{$page_name}}" method="post" class="de {{if $can_edit_all==0}}de_readonly{{/if}}" name="{{$smarty.now}}" data-editor-name="category_group_edit">
	<div>
	...
	<div class="de_main">
		<div class="de_header"><h1><a href="{{$page_name}}">{{$lang.categorization.submenu_option_category_groups_list}}</a> / {{if $smarty.get.action=='add_new'}}{{$lang.categorization.category_group_add}}{{else}}{{$lang.categorization.category_group_edit|replace:"%1%":$smarty.post.title}}{{/if}}</h1></div>
		<table class="de_editor">
			...
			{{if $options.ENABLE_CATEGORY_GROUP_FIELD_1==1 || $options.ENABLE_CATEGORY_GROUP_FIELD_2==1 || $options.ENABLE_CATEGORY_GROUP_FIELD_3==1}}
				<tr>
					<td class="de_separator" colspan="3"><h2>{{$lang.categorization.category_group_divider_general}}</h2></td>
				</tr>
			{{/if}}
			<tr>
			...
			{{if $smarty.get.action=='change'}}
				<tr>
					...
					<td class="de_control">
						...
						<span class="de_hint">{{$lang.categorization.category_group_field_directory_hint|replace:"%1%":$lang.categorization.category_group_field_title}}</span>
					</td>
				</tr>
			{{/if}}
			<tr>
				...
				<td class="de_control">
					...
					<span class="de_hint">{{$lang.categorization.category_group_field_external_id_hint}}</span>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="de_control">
					<span class="de_lv_pair"><input type="checkbox" name="status_id" value="1" {{if $smarty.post.status_id=='1'}}checked{{/if}}/><label>{{$lang.categorization.category_group_field_status_active}}</label></span>
					<span class="de_hint">{{$lang.categorization.category_group_field_status_hint}}</span>
				</td>
			</tr>
			<tr>
				...
				<td class="de_control">
					...
					<span class="de_hint">{{$lang.categorization.category_group_field_screenshot1_hint}} (<a href="options.php?page=general_settings">{{$options.CATEGORY_AVATAR_SIZE}}</a>)</span>
				</td>
			</tr>
			{{if $options.CATEGORY_AVATAR_OPTION>0}}
				<tr>
					...
					<td class="de_control">
						...
						<span class="de_hint">{{$lang.categorization.category_group_field_screenshot2_hint}} (<a href="options.php?page=general_settings">{{$options.CATEGORY_AVATAR_2_SIZE}}</a>){{if $options.CATEGORY_AVATAR_OPTION==1}}; {{$lang.categorization.category_group_field_screenshot2_hint2|replace:"%1%":$lang.categorization.category_group_field_screenshot1}}{{/if}}</span>
					</td>
				</tr>
			{{/if}}
			{{if $options.ENABLE_CATEGORY_GROUP_FIELD_1==1 || $options.ENABLE_CATEGORY_GROUP_FIELD_2==1 || $options.ENABLE_CATEGORY_GROUP_FIELD_3==1}}
				<tr>
					<td class="de_separator" colspan="3"><h2>{{$lang.categorization.category_group_divider_customization}}</h2></td>
				</tr>
			...
			<div class="dgf_advanced_filters">
				<div class="dgf_filter">
					<select name="se_status_id">
						<option value="">{{$lang.categorization.category_group_field_status}}...</option>
						<option value="1" {{if $smarty.session.save.$page_name.se_status_id=='1'}}selected{{/if}}>{{$lang.categorization.category_group_field_status_active}}</option>
						<option value="0" {{if $smarty.session.save.$page_name.se_status_id=='0'}}selected{{/if}}>{{$lang.categorization.category_group_field_status_disabled}}</option>
					</select>
				</div>
				<div class="dgf_filter">
					<select name="se_field">
						<option value="">{{$lang.common.dg_filter_field}}...</option>
						<option value="empty/description" {{if $smarty.session.save.$page_name.se_field=="empty/description"}}selected{{/if}}>{{$lang.common.dg_filter_option_empty_field|replace:"%1%":$lang.categorization.category_group_field_description}}</option>
						<option value="empty/screenshot1" {{if $smarty.session.save.$page_name.se_field=="empty/screenshot1"}}selected{{/if}}>{{$lang.common.dg_filter_option_empty_field|replace:"%1%":$lang.categorization.category_group_field_screenshot1}}</option>
						<option value="empty/screenshot2" {{if $smarty.session.save.$page_name.se_field=="empty/screenshot2"}}selected{{/if}}>{{$lang.common.dg_filter_option_empty_field|replace:"%1%":$lang.categorization.category_group_field_screenshot2}}</option>
						{{section name="data" start="1" loop="11"}}
							...
							{{/if}}
						{{/section}}
						<option value="filled/description" {{if $smarty.session.save.$page_name.se_field=="filled/description"}}selected{{/if}}>{{$lang.common.dg_filter_option_non_empty_field|replace:"%1%":$lang.categorization.category_group_field_description}}</option>
						<option value="filled/screenshot1" {{if $smarty.session.save.$page_name.se_field=="filled/screenshot1"}}selected{{/if}}>{{$lang.common.dg_filter_option_non_empty_field|replace:"%1%":$lang.categorization.category_group_field_screenshot1}}</option>
						<option value="filled/screenshot2" {{if $smarty.session.save.$page_name.se_field=="filled/screenshot2"}}selected{{/if}}>{{$lang.common.dg_filter_option_non_empty_field|replace:"%1%":$lang.categorization.category_group_field_screenshot2}}</option>
						{{section name="data" start="1" loop="11"}}
							{{assign var="custom_field_id" value="custom`$smarty.section.data.index`"}}
							{{assign var="custom_field_name_id" value="CATEGORY_GROUP_FIELD_`$smarty.section.data.index`_NAME"}}
							{{assign var="custom_field_enable_id" value="ENABLE_CATEGORY_GROUP_FIELD_`$smarty.section.data.index`"}}
				...
				<div class="dgf_filter">
					<select name="se_usage">
						...
						<option value="used/categories" {{if $smarty.session.save.$page_name.se_usage=="used/categories"}}selected{{/if}}>{{$lang.common.dg_filter_usage_categories}}</option>
						<option value="notused/categories" {{if $smarty.session.save.$page_name.se_usage=="notused/categories"}}selected{{/if}}>{{$lang.common.dg_filter_usage_no_categories}}</option>
					</select>
				</div>
			</div>
