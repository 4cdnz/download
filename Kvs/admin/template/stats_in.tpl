	...
	<form action="{{$page_name}}" method="get" class="form_dgf" name="{{$smarty.now}}">
		<div class="dgf">
			<div class="dgf_filter">
				<div class="drop">
					<i class="icon icon-action-groupby"></i><span>{{$lang.stats.incoming_filter_group_by}}</span>
					<ul>
						<li {{if $smarty.session.save.$page_name.se_group_by=='date'}}class="selected"{{/if}}><a href="{{$page_name}}?se_group_by=date">{{$lang.stats.incoming_filter_group_by_date}}</a></li>
						<li {{if $smarty.session.save.$page_name.se_group_by=='referer'}}class="selected"{{/if}}><a href="{{$page_name}}?se_group_by=referer">{{$lang.stats.incoming_filter_group_by_referer}}</a></li>
						<li {{if $smarty.session.save.$page_name.se_group_by=='country'}}class="selected"{{/if}}><a href="{{$page_name}}?se_group_by=country">{{$lang.stats.incoming_filter_group_by_country}}</a></li>
						<li {{if $smarty.session.save.$page_name.se_group_by=='device'}}class="selected"{{/if}}><a href="{{$page_name}}?se_group_by=device">{{$lang.stats.incoming_filter_group_by_device}}</a></li>
					</ul>
				</div>
			</div>
			<div class="dgf_reset">
