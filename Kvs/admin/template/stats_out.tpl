	...
	<form action="{{$page_name}}" method="get" class="form_dgf" name="{{$smarty.now}}">
		<div class="dgf">
			<div class="dgf_filter">
				<div class="drop">
					<i class="icon icon-action-groupby"></i><span>{{$lang.stats.outgoing_filter_group_by}}</span>
					<ul>
						<li {{if $smarty.session.save.$page_name.se_group_by=='date'}}class="selected"{{/if}}><a href="{{$page_name}}?se_group_by=date">{{$lang.stats.outgoing_filter_group_by_date}}</a></li>
						<li {{if $smarty.session.save.$page_name.se_group_by=='content_source'}}class="selected"{{/if}}><a href="{{$page_name}}?se_group_by=content_source">{{$lang.stats.outgoing_filter_group_by_content_source}}</a></li>
					</ul>
				</div>
			</div>
			<div class="dgf_reset">
