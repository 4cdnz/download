			...
			<div class="dgf_advanced_filters">
				<div class="dgf_filter">
					<div class="insight">
						...
						<input type="text" name="se_user" value="{{$smarty.session.save.$page_name.se_user}}" placeholder="{{$lang.stats.users_field_user}}..."/>
					</div>
				</div>
				<div class="dgf_filter">
					<select name="se_status_id">
						<option value="">{{$lang.stats.users_field_status}}...</option>
						<option value="0" {{if $smarty.session.save.$page_name.se_status_id=='0'}}selected{{/if}}>{{$lang.stats.users_field_status_disabled}}</option>
						<option value="2" {{if $smarty.session.save.$page_name.se_status_id=='2'}}selected{{/if}}>{{$lang.stats.users_field_status_active}}</option>
						<option value="3" {{if $smarty.session.save.$page_name.se_status_id=='3'}}selected{{/if}}>{{$lang.stats.users_field_status_premium}}</option>
						<option value="6" {{if $smarty.session.save.$page_name.se_status_id=='6'}}selected{{/if}}>{{$lang.stats.users_field_status_webmaster}}</option>
					</select>
				</div>
