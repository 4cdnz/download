...
<form action="{{$page_name}}" method="post" class="de {{if $smarty.post.status_id!=1}}de_readonly{{/if}}" name="{{$smarty.now}}" data-editor-name="format_album">
	<div class="de_main">
		<div class="de_header"><h1><a href="{{$page_name}}">{{$lang.settings.submenu_option_formats_albums_list}}</a> / {{if $smarty.get.action=='add_new'}}{{$lang.settings.format_album_add}}{{else}}{{$lang.settings.format_album_edit|replace:"%1%":$smarty.post.title}}{{/if}}</h1></div>
		<table class="de_editor">
			...
			{{if $smarty.get.item_id=='source'}}
				<tr>
					<td class="de_separator" colspan="2"><h2>{{$lang.settings.format_album_divider_source}}</h2></td>
				</tr>
				<tr>
					<td class="de_label">{{$lang.settings.format_album_field_create_zip}}</td>
					<td class="de_control">
						<span class="de_lv_pair de_vis_sw_checkbox"><input type="checkbox" name="is_create_zip" value="1" {{if $smarty.post.is_create_zip==1}}checked{{/if}}/><label>{{$lang.settings.format_album_field_create_zip_yes}}</label></span>
						<span class="de_hint">{{$lang.settings.format_album_field_create_zip_hint}}</span>
					</td>
				</tr>
				<tr>
					...
					<td class="de_control">
						<select name="access_level_id">
							<option value="0" {{if $smarty.post.access_level_id==0}}selected{{/if}}>{{$lang.settings.format_album_field_access_level_any}}</option>
							<option value="1" {{if $smarty.post.access_level_id==1}}selected{{/if}}>{{$lang.settings.format_album_field_access_level_member}}</option>
							<option value="2" {{if $smarty.post.access_level_id==2}}selected{{/if}}>{{$lang.settings.format_album_field_access_level_premium}}</option>
							<option value="3" {{if $smarty.post.access_level_id==3}}selected{{/if}}>{{$lang.settings.format_album_field_access_level_none}}</option>
						</select>
						<span class="de_hint">{{$lang.settings.format_album_field_access_level_hint}}</span>
					</td>
				</tr>
				<tr>
					...
					<td class="de_control">
						<div class="de_fu">
							...
							<input type="text" name="access_level_image" maxlength="100" {{if $smarty.post.access_level_image!=''}}value="{{$smarty.post.access_level_image}}"{{/if}}/>
						...
						<span class="de_hint">{{$lang.settings.format_album_field_access_level_image_hint}}</span>
					</td>
				</tr>
			{{else}}
				<tr>
					<td class="de_separator" colspan="2"><h2>{{$lang.settings.format_album_divider_general}}</h2></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="de_control de_vis_sw_select">
						<select name="group_id" {{if $smarty.get.action!='add_new'}}disabled{{/if}}>
							<option value="1" {{if $smarty.post.group_id==1}}selected{{/if}}>{{$lang.settings.format_album_field_group_main}}</option>
							<option value="2" {{if $smarty.post.group_id==2}}selected{{/if}}>{{$lang.settings.format_album_field_group_preview}}</option>
						</select>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="de_control">
						...
						<span class="de_hint">{{$lang.settings.format_album_field_im_options_hint}}</span>
					</td>
				</tr>
				<tr>
					<td class="de_label">{{$lang.settings.format_album_field_skip_crop}}</td>
					<td class="de_control">
						<span class="de_lv_pair"><input type="checkbox" name="is_skip_crop" value="1" {{if $smarty.post.is_skip_crop==1}}checked{{/if}}/><label>{{$lang.settings.format_album_field_skip_crop_yes}}</label></span>
						<span class="de_hint">{{$lang.settings.format_album_field_skip_crop_hint|replace:"%1%":$crop_options.left|replace:"%2%":$crop_options.top|replace:"%3%":$crop_options.right|replace:"%4%":$crop_options.bottom}}</span>
					</td>
				</tr>
				<tr>
						...
						<table class="control_group">
							<tr>
								<td class="group_label">
									{{$lang.settings.format_album_field_aspect_ratio_horizontal}}:
								</td>
								<td class="de_vis_sw_select">
									<select name="aspect_ratio_id">
										<option value="1" {{if $smarty.post.aspect_ratio_id==1}}selected{{/if}}>{{$lang.settings.format_album_field_aspect_ratio_preserve_source}}</option>
										<option value="2" {{if $smarty.post.aspect_ratio_id==2}}selected{{/if}}>{{$lang.settings.format_album_field_aspect_ratio_convert_to_target}}</option>
										<option value="3" {{if $smarty.post.aspect_ratio_id==3}}selected{{/if}}>{{$lang.settings.format_album_field_aspect_ratio_dynamic_size}}</option>
										<option value="4" {{if $smarty.post.aspect_ratio_id==4}}selected{{/if}}>{{$lang.settings.format_album_field_aspect_ratio_dynamic_width}}</option>
										<option value="5" {{if $smarty.post.aspect_ratio_id==5}}selected{{/if}}>{{$lang.settings.format_album_field_aspect_ratio_dynamic_height}}</option>
									</select>
									<span class="aspect_ratio_id_2">
										{{$lang.settings.format_album_field_aspect_ratio_gravity}}:
										<select name="aspect_ratio_gravity">
											<option value="" {{if $smarty.post.aspect_ratio_gravity==''}}selected{{/if}}>{{$lang.settings.format_album_field_aspect_ratio_gravity_center}}</option>
											<option value="North" {{if $smarty.post.aspect_ratio_gravity=='North'}}selected{{/if}}>{{$lang.settings.format_album_field_aspect_ratio_gravity_north}}</option>
											<option value="West" {{if $smarty.post.aspect_ratio_gravity=='West'}}selected{{/if}}>{{$lang.settings.format_album_field_aspect_ratio_gravity_west}}</option>
											<option value="East" {{if $smarty.post.aspect_ratio_gravity=='East'}}selected{{/if}}>{{$lang.settings.format_album_field_aspect_ratio_gravity_east}}</option>
											<option value="South" {{if $smarty.post.aspect_ratio_gravity=='South'}}selected{{/if}}>{{$lang.settings.format_album_field_aspect_ratio_gravity_south}}</option>
										</select>
									</span>
								</td>
							</tr>
							<tr>
								<td class="group_label">
									{{$lang.settings.format_album_field_aspect_ratio_vertical}}:
								</td>
								<td class="de_vis_sw_select">
									<select name="vertical_aspect_ratio_id">
										<option value="1" {{if $smarty.post.vertical_aspect_ratio_id==1}}selected{{/if}}>{{$lang.settings.format_album_field_aspect_ratio_preserve_source}}</option>
										<option value="2" {{if $smarty.post.vertical_aspect_ratio_id==2}}selected{{/if}}>{{$lang.settings.format_album_field_aspect_ratio_convert_to_target}}</option>
										<option value="3" {{if $smarty.post.vertical_aspect_ratio_id==3}}selected{{/if}}>{{$lang.settings.format_album_field_aspect_ratio_dynamic_size}}</option>
										<option value="4" {{if $smarty.post.vertical_aspect_ratio_id==4}}selected{{/if}}>{{$lang.settings.format_album_field_aspect_ratio_dynamic_width}}</option>
										<option value="5" {{if $smarty.post.vertical_aspect_ratio_id==5}}selected{{/if}}>{{$lang.settings.format_album_field_aspect_ratio_dynamic_height}}</option>
									</select>
									<span class="vertical_aspect_ratio_id_2">
										{{$lang.settings.format_album_field_aspect_ratio_gravity}}:
										<select name="vertical_aspect_ratio_gravity">
											<option value="" {{if $smarty.post.vertical_aspect_ratio_gravity==''}}selected{{/if}}>{{$lang.settings.format_album_field_aspect_ratio_gravity_center}}</option>
											<option value="North" {{if $smarty.post.vertical_aspect_ratio_gravity=='North'}}selected{{/if}}>{{$lang.settings.format_album_field_aspect_ratio_gravity_north}}</option>
											<option value="West" {{if $smarty.post.vertical_aspect_ratio_gravity=='West'}}selected{{/if}}>{{$lang.settings.format_album_field_aspect_ratio_gravity_west}}</option>
											<option value="East" {{if $smarty.post.vertical_aspect_ratio_gravity=='East'}}selected{{/if}}>{{$lang.settings.format_album_field_aspect_ratio_gravity_east}}</option>
											<option value="South" {{if $smarty.post.vertical_aspect_ratio_gravity=='South'}}selected{{/if}}>{{$lang.settings.format_album_field_aspect_ratio_gravity_south}}</option>
										</select>
									</span>
								</td>
							</tr>
				...
				<tr>
					...
					<td class="de_control">
						<select name="interlace_id">
							<option value="0" {{if $smarty.post.interlace_id==0}}selected{{/if}}>{{$lang.settings.format_album_field_interlace_none}}</option>
							<option value="1" {{if $smarty.post.interlace_id==1}}selected{{/if}}>{{$lang.settings.format_album_field_interlace_line}}</option>
							<option value="2" {{if $smarty.post.interlace_id==2}}selected{{/if}}>{{$lang.settings.format_album_field_interlace_plane}}</option>
						</select>
						<span class="de_hint">{{$lang.settings.format_album_field_interlace_hint}}</span>
					</td>
				</tr>
				<tr>
					...
					<td class="de_control">
						...
						<span class="de_hint">{{$lang.settings.format_album_field_comment_hint}}</span>
					</td>
				</tr>
				<tr class="group_id_1">
					<td class="de_label">{{$lang.settings.format_album_field_create_zip}}</td>
					<td class="de_control">
						<span class="de_lv_pair de_vis_sw_checkbox"><input type="checkbox" name="is_create_zip" value="1" class="group_id_1" {{if $smarty.post.is_create_zip==1}}checked{{/if}}/><label>{{$lang.settings.format_album_field_create_zip_yes}}</label></span>
						<span class="de_hint">{{$lang.settings.format_album_field_create_zip_hint}}</span>
					</td>
				</tr>
				<tr>
					<td class="de_separator" colspan="2"><h2>{{$lang.settings.format_album_divider_watermark}}</h2></td>
				</tr>
				<tr>
					...
					<td class="de_control">
						...
						<span class="de_hint">{{$lang.settings.format_album_field_watermark_image_hint}}</span>
					</td>
				</tr>
				<tr>
					...
					<td class="de_control">
						<select name="watermark_position_id">
							<option value="0" {{if $smarty.post.watermark_position_id==0}}selected{{/if}}>{{$lang.settings.format_album_field_watermark_position_random}}</option>
							<option value="1" {{if $smarty.post.watermark_position_id==1}}selected{{/if}}>{{$lang.settings.format_album_field_watermark_position_top_left}}</option>
							<option value="2" {{if $smarty.post.watermark_position_id==2}}selected{{/if}}>{{$lang.settings.format_album_field_watermark_position_top_right}}</option>
							<option value="3" {{if $smarty.post.watermark_position_id==3}}selected{{/if}}>{{$lang.settings.format_album_field_watermark_position_bottom_right}}</option>
							<option value="4" {{if $smarty.post.watermark_position_id==4}}selected{{/if}}>{{$lang.settings.format_album_field_watermark_position_bottom_left}}</option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td class="de_control">
						<span>
							{{$lang.settings.format_album_field_watermark_max_width_horizontal}}:
							<input type="text" name="watermark_max_width" maxlength="10" size="5" value="{{$smarty.post.watermark_max_width}}"/>
							%
						</span>
						<span>
							{{$lang.settings.format_album_field_watermark_max_width_vertical}}:
							<input type="text" name="watermark_max_width_vertical" maxlength="10" size="5" value="{{$smarty.post.watermark_max_width_vertical}}"/>
							%
						</span>
						<span class="de_hint">{{$lang.settings.format_album_field_watermark_max_width_hint}}</span>
					</td>
				</tr>
				<tr>
					<td class="de_separator" colspan="2"><h2>{{$lang.settings.format_album_divider_access}}</h2></td>
				</tr>
				<tr>
					<td class="de_label">{{$lang.settings.format_album_field_access_level}}</td>
					<td class="de_control">
	...
	<div class="de_action_group">
		...
		{{else}}
			...
			{{if $smarty.post.zip_albums_count>0}}
				<span class="de_separated_group">
					<input type="submit" name="save_and_delete_zip_files" value="{{$lang.settings.format_album_action_delete_zip}}" class="destructive is_create_zip_off" data-confirm="{{$lang.settings.format_album_action_delete_zip_confirm|replace:"%1%":$smarty.post.title}}"/>
				</span>
			{{/if}}
		{{/if}}
	</div>
