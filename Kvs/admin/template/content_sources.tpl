...
<form action="{{$page_name}}" method="post" class="de {{if $can_edit_all==0}}de_readonly{{/if}}" name="{{$smarty.now}}" data-editor-name="content_source_edit">
	<div>
	...
	<div class="de_main">
		...
		<table class="de_editor">
			...
			<tr>
				<td class="de_separator" colspan="3"><h2>{{$lang.categorization.content_source_divider_general}}</h2></td>
			</tr>
			<tr>
			...
			{{if $smarty.get.action=='change'}}
				<tr>
					...
					<td class="de_control">
						...
						<span class="de_hint">{{$lang.categorization.content_source_field_directory_hint|replace:"%1%":$lang.categorization.content_source_field_title}}</span>
					</td>
				</tr>
			{{/if}}
			{{if $smarty.post.website_link!=''}}
			...
			<tr>
				...
				<td class="de_control">
					...
					<span class="de_hint">{{$lang.categorization.content_source_field_url_hint}}</span>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="de_label">{{$lang.categorization.content_source_field_synonyms}}</td>
				<td class="de_control">
					<textarea name="synonyms" cols="40" rows="4">{{$smarty.post.synonyms}}</textarea>
					<span class="de_hint">{{$lang.categorization.content_source_field_synonyms_hint}}</span>
				</td>
			</tr>
			<tr>
				<td class="de_label">{{$lang.categorization.content_source_field_status}}</td>
				<td class="de_control">
					<span class="de_lv_pair"><input type="checkbox" name="status_id" value="1" {{if $smarty.post.status_id=='1'}}checked{{/if}}/><label>{{$lang.categorization.content_source_field_status_active}}</label></span>
					<span class="de_hint">{{$lang.categorization.content_source_field_status_hint}}</span>
				</td>
			</tr>
			<tr>
					...
					<div class="insight">
						<div class="js_params">
							...
							{{if in_array('content_sources_groups|view',$smarty.session.permissions)}}
								...
								<span class="js_param">view_id={{$smarty.post.content_source_group_id}}</span>
							{{/if}}
						</div>
						<input type="text" name="content_source_group" maxlength="255" value="{{$smarty.post.content_source_group}}"/>
					</div>
				</td>
			</tr>
			<tr>
				...
				<td class="de_control">
					...
					<span class="de_hint">{{$lang.categorization.content_source_field_screenshot1_hint}} (<a href="options.php?page=general_settings">{{$options.CS_SCREENSHOT_1_SIZE}}</a>)</span>
				</td>
			</tr>
			{{if $options.CS_SCREENSHOT_OPTION>0}}
				<tr>
					...
					<td class="de_control">
						...
						<span class="de_hint">{{$lang.categorization.content_source_field_screenshot2_hint}} (<a href="options.php?page=general_settings">{{$options.CS_SCREENSHOT_2_SIZE}}</a>){{if $options.CS_SCREENSHOT_OPTION==1}}; {{$lang.categorization.content_source_field_screenshot2_hint2|replace:"%1%":$lang.categorization.content_source_field_screenshot1}}{{/if}}</span>
					</td>
				</tr>
			{{/if}}
			<tr>
				...
				<td class="de_control">
					...
					<span class="de_hint">{{$lang.categorization.content_source_field_rating_hint}}</span>
				</td>
			</tr>
			<tr>
				<td class="de_separator" colspan="3"><h2>{{$lang.categorization.content_source_divider_categorization}}</h2></td>
			</tr>
			<tr>
				...
				<td class="de_control" colspan="2">
					<div class="de_insight_list">
						<div class="js_params">
							<span class="js_param">title={{$lang.categorization.content_source_field_tags}}</span>
			...
			<tr>
				...
				<td class="de_control" colspan="2">
					<div class="de_insight_list">
						<div class="js_params">
							<span class="js_param">title={{$lang.categorization.content_source_field_categories}}</span>
			...
			{{if $options.ENABLE_CS_FIELD_1==1 || $options.ENABLE_CS_FIELD_2==1 || $options.ENABLE_CS_FIELD_3==1 || $options.ENABLE_CS_FIELD_4==1 || $options.ENABLE_CS_FIELD_5==1 || $options.ENABLE_CS_FIELD_6==1 || $options.ENABLE_CS_FIELD_7==1 || $options.ENABLE_CS_FIELD_8==1 || $options.ENABLE_CS_FIELD_9==1 || $options.ENABLE_CS_FIELD_10==1
				...
				<tr>
					<td class="de_separator" colspan="3"><h2>{{$lang.categorization.content_source_divider_customization}}</h2></td>
				</tr>
					...
					<tr>
						...
						<td class="de_control" colspan="2">
							<div class="de_fu">
								...
								<input type="text" name="custom_file6" maxlength="100" {{if $smarty.get.action=='change' && $smarty.post.custom_file6!=''}}value="{{$smarty.post.custom_file6}}"{{/if}}/>
								<input type="hidden" name="custom_file6_hash"/>
								<input type="button" class="de_fu_upload" value="{{$lang.common.attachment_btn_upload}}"/>
								<input type="button" class="de_fu_remove" value="{{$lang.common.attachment_btn_remove}}"/>
							</div>
					...
					<tr>
						...
						<td class="de_control" colspan="2">
							<div class="de_fu">
								...
								<input type="text" name="custom_file7" maxlength="100" {{if $smarty.get.action=='change' && $smarty.post.custom_file7!=''}}value="{{$smarty.post.custom_file7}}"{{/if}}/>
								<input type="hidden" name="custom_file7_hash"/>
								<input type="button" class="de_fu_upload" value="{{$lang.common.attachment_btn_upload}}"/>
								<input type="button" class="de_fu_remove" value="{{$lang.common.attachment_btn_remove}}"/>
							</div>
					...
					<tr>
						...
						<td class="de_control" colspan="2">
							<div class="de_fu">
								...
								<input type="text" name="custom_file8" maxlength="100" {{if $smarty.get.action=='change' && $smarty.post.custom_file8!=''}}value="{{$smarty.post.custom_file8}}"{{/if}}/>
								<input type="hidden" name="custom_file8_hash"/>
								<input type="button" class="de_fu_upload" value="{{$lang.common.attachment_btn_upload}}"/>
								<input type="button" class="de_fu_remove" value="{{$lang.common.attachment_btn_remove}}"/>
							</div>
					...
					<tr>
						...
						<td class="de_control" colspan="2">
							<div class="de_fu">
								...
								<input type="text" name="custom_file9" maxlength="100" {{if $smarty.get.action=='change' && $smarty.post.custom_file9!=''}}value="{{$smarty.post.custom_file9}}"{{/if}}/>
								<input type="hidden" name="custom_file9_hash"/>
								<input type="button" class="de_fu_upload" value="{{$lang.common.attachment_btn_upload}}"/>
								<input type="button" class="de_fu_remove" value="{{$lang.common.attachment_btn_remove}}"/>
							</div>
					...
					<tr>
						...
						<td class="de_control" colspan="2">
							<div class="de_fu">
								...
								<input type="text" name="custom_file10" maxlength="100" {{if $smarty.get.action=='change' && $smarty.post.custom_file10!=''}}value="{{$smarty.post.custom_file10}}"{{/if}}/>
								<input type="hidden" name="custom_file10_hash"/>
								<input type="button" class="de_fu_upload" value="{{$lang.common.attachment_btn_upload}}"/>
								<input type="button" class="de_fu_remove" value="{{$lang.common.attachment_btn_remove}}"/>
							</div>
			...
			<div class="dgf_advanced_filters">
				<div class="dgf_filter">
					<select name="se_status_id">
						<option value="">{{$lang.categorization.content_source_field_status}}...</option>
						<option value="1" {{if $smarty.session.save.$page_name.se_status_id=='1'}}selected{{/if}}>{{$lang.categorization.content_source_field_status_active}}</option>
						<option value="0" {{if $smarty.session.save.$page_name.se_status_id=='0'}}selected{{/if}}>{{$lang.categorization.content_source_field_status_disabled}}</option>
					</select>
				</div>
				<div class="dgf_filter">
					<div class="insight">
						...
						<input type="text" name="se_content_source_group" value="{{$smarty.session.save.$page_name.se_content_source_group}}" placeholder="{{$lang.categorization.content_source_field_group}}..."/>
					</div>
				</div>
				<div class="dgf_filter">
					<div class="insight">
						...
						<input type="text" name="se_tag" value="{{$smarty.session.save.$page_name.se_tag}}" placeholder="{{$lang.categorization.content_source_field_tag}}..."/>
					</div>
				</div>
				<div class="dgf_filter">
					<div class="insight">
						...
						<input type="text" name="se_category" value="{{$smarty.session.save.$page_name.se_category}}" placeholder="{{$lang.categorization.content_source_field_category}}..."/>
					</div>
				</div>
				<div class="dgf_filter">
					<select name="se_field">
						<option value="">{{$lang.common.dg_filter_field}}...</option>
						<option value="empty/url" {{if $smarty.session.save.$page_name.se_field=="empty/url"}}selected{{/if}}>{{$lang.common.dg_filter_option_empty_field|replace:"%1%":$lang.categorization.content_source_field_url}}</option>
						<option value="empty/description" {{if $smarty.session.save.$page_name.se_field=="empty/description"}}selected{{/if}}>{{$lang.common.dg_filter_option_empty_field|replace:"%1%":$lang.categorization.content_source_field_description}}</option>
						<option value="empty/synonyms" {{if $smarty.session.save.$page_name.se_field=="empty/synonyms"}}selected{{/if}}>{{$lang.common.dg_filter_option_empty_field|replace:"%1%":$lang.categorization.content_source_field_synonyms}}</option>
						<option value="empty/group" {{if $smarty.session.save.$page_name.se_field=="empty/group"}}selected{{/if}}>{{$lang.common.dg_filter_option_empty_field|replace:"%1%":$lang.categorization.content_source_field_group}}</option>
						<option value="empty/screenshot1" {{if $smarty.session.save.$page_name.se_field=="empty/screenshot1"}}selected{{/if}}>{{$lang.common.dg_filter_option_empty_field|replace:"%1%":$lang.categorization.content_source_field_screenshot1}}</option>
						<option value="empty/screenshot2" {{if $smarty.session.save.$page_name.se_field=="empty/screenshot2"}}selected{{/if}}>{{$lang.common.dg_filter_option_empty_field|replace:"%1%":$lang.categorization.content_source_field_screenshot2}}</option>
						<option value="empty/rating" {{if $smarty.session.save.$page_name.se_field=="empty/rating"}}selected{{/if}}>{{$lang.common.dg_filter_option_empty_field|replace:"%1%":$lang.categorization.content_source_field_rating}}</option>
						<option value="empty/cs_viewed" {{if $smarty.session.save.$page_name.se_field=="empty/cs_viewed"}}selected{{/if}}>{{$lang.common.dg_filter_option_empty_field|replace:"%1%":$lang.categorization.content_source_field_visits}}</option>
						<option value="empty/tags" {{if $smarty.session.save.$page_name.se_field=="empty/tags"}}selected{{/if}}>{{$lang.common.dg_filter_option_empty_field|replace:"%1%":$lang.categorization.content_source_field_tags}}</option>
						<option value="empty/categories" {{if $smarty.session.save.$page_name.se_field=="empty/categories"}}selected{{/if}}>{{$lang.common.dg_filter_option_empty_field|replace:"%1%":$lang.categorization.content_source_field_categories}}</option>
						...
						{{section name="data" start="1" loop="11"}}
							...
							{{/if}}
						{{/section}}
						<option value="filled/url" {{if $smarty.session.save.$page_name.se_field=="filled/url"}}selected{{/if}}>{{$lang.common.dg_filter_option_non_empty_field|replace:"%1%":$lang.categorization.content_source_field_url}}</option>
						<option value="filled/description" {{if $smarty.session.save.$page_name.se_field=="filled/description"}}selected{{/if}}>{{$lang.common.dg_filter_option_non_empty_field|replace:"%1%":$lang.categorization.content_source_field_description}}</option>
						<option value="filled/synonyms" {{if $smarty.session.save.$page_name.se_field=="filled/synonyms"}}selected{{/if}}>{{$lang.common.dg_filter_option_non_empty_field|replace:"%1%":$lang.categorization.content_source_field_synonyms}}</option>
						<option value="filled/group" {{if $smarty.session.save.$page_name.se_field=="filled/group"}}selected{{/if}}>{{$lang.common.dg_filter_option_non_empty_field|replace:"%1%":$lang.categorization.content_source_field_group}}</option>
						<option value="filled/screenshot1" {{if $smarty.session.save.$page_name.se_field=="filled/screenshot1"}}selected{{/if}}>{{$lang.common.dg_filter_option_non_empty_field|replace:"%1%":$lang.categorization.content_source_field_screenshot1}}</option>
						<option value="filled/screenshot2" {{if $smarty.session.save.$page_name.se_field=="filled/screenshot2"}}selected{{/if}}>{{$lang.common.dg_filter_option_non_empty_field|replace:"%1%":$lang.categorization.content_source_field_screenshot2}}</option>
						<option value="filled/rating" {{if $smarty.session.save.$page_name.se_field=="filled/rating"}}selected{{/if}}>{{$lang.common.dg_filter_option_non_empty_field|replace:"%1%":$lang.categorization.content_source_field_rating}}</option>
						<option value="filled/cs_viewed" {{if $smarty.session.save.$page_name.se_field=="filled/cs_viewed"}}selected{{/if}}>{{$lang.common.dg_filter_option_non_empty_field|replace:"%1%":$lang.categorization.content_source_field_visits}}</option>
						<option value="filled/tags" {{if $smarty.session.save.$page_name.se_field=="filled/tags"}}selected{{/if}}>{{$lang.common.dg_filter_option_non_empty_field|replace:"%1%":$lang.categorization.content_source_field_tags}}</option>
						<option value="filled/categories" {{if $smarty.session.save.$page_name.se_field=="filled/categories"}}selected{{/if}}>{{$lang.common.dg_filter_option_non_empty_field|replace:"%1%":$lang.categorization.content_source_field_categories}}</option>
						{{section name="data" start="1" loop="11"}}
							{{assign var="custom_field_id" value="custom`$smarty.section.data.index`"}}
							{{assign var="custom_field_name_id" value="CS_FIELD_`$smarty.section.data.index`_NAME"}}
							{{assign var="custom_field_enable_id" value="ENABLE_CS_FIELD_`$smarty.section.data.index`"}}
