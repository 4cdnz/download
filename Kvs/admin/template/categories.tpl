...
<form action="{{$page_name}}" method="post" class="de {{if $can_edit_all==0}}de_readonly{{/if}}" name="{{$smarty.now}}" data-editor-name="category_edit">
	<div>
	...
	<div class="de_main">
		...
		<table class="de_editor">
			...
			{{if $options.ENABLE_CATEGORY_FIELD_1==1 || $options.ENABLE_CATEGORY_FIELD_2==1 || $options.ENABLE_CATEGORY_FIELD_3==1 || $options.ENABLE_CATEGORY_FIELD_4==1 || $options.ENABLE_CATEGORY_FIELD_5==1 || $options.ENABLE_CATEGORY_FIELD_6==1 || $options.ENABLE_CATEGORY_FIELD_7==1 || $options.ENABLE_CATEGORY_FIELD_8==1 || $options.ENABLE_CATEGORY_FIELD_9==1 || $options.ENABLE_CATEGORY_FIELD_10==1
				...
				<tr>
					<td class="de_separator" colspan="3"><h2>{{$lang.categorization.category_divider_general}}</h2></td>
				</tr>
			{{/if}}
			<tr>
			...
			{{if $smarty.get.action=='change'}}
				<tr>
					...
					<td class="de_control">
						...
						<span class="de_hint">{{$lang.categorization.category_field_directory_hint|replace:"%1%":$lang.categorization.category_field_title}}</span>
					</td>
				</tr>
			{{/if}}
			<tr>
			...
			<tr>
				...
				<td class="de_control">
					...
					<span class="de_hint">{{$lang.categorization.category_field_synonyms_hint}}</span>
				</td>
			</tr>
			<tr>
				<td class="de_label">{{$lang.categorization.category_field_status}}</td>
				<td class="de_control">
					<span class="de_lv_pair"><input type="checkbox" name="status_id" value="1" {{if $smarty.post.status_id=='1'}}checked{{/if}}/><label>{{$lang.categorization.category_field_status_active}}</label></span>
					<span class="de_hint">{{$lang.categorization.category_field_status_hint}}</span>
				</td>
			</tr>
			<tr>
					...
					<div class="insight">
						<div class="js_params">
							...
							{{if in_array('category_groups|view',$smarty.session.permissions)}}
								...
								<span class="js_param">view_id={{$smarty.post.category_group_id}}</span>
							{{/if}}
						</div>
						<input type="text" name="category_group" maxlength="255" value="{{$smarty.post.category_group}}"/>
					</div>
				</td>
			</tr>
			<tr>
			...
			{{if $options.ENABLE_CATEGORY_FIELD_1==1 || $options.ENABLE_CATEGORY_FIELD_2==1 || $options.ENABLE_CATEGORY_FIELD_3==1 || $options.ENABLE_CATEGORY_FIELD_4==1 || $options.ENABLE_CATEGORY_FIELD_5==1 || $options.ENABLE_CATEGORY_FIELD_6==1 || $options.ENABLE_CATEGORY_FIELD_7==1 || $options.ENABLE_CATEGORY_FIELD_8==1 || $options.ENABLE_CATEGORY_FIELD_9==1 || $options.ENABLE_CATEGORY_FIELD_10==1
					|| $options.ENABLE_CATEGORY_FILE_FIELD_1==1 || $options.ENABLE_CATEGORY_FILE_FIELD_2==1 || $options.ENABLE_CATEGORY_FILE_FIELD_3==1 || $options.ENABLE_CATEGORY_FILE_FIELD_4==1 || $options.ENABLE_CATEGORY_FILE_FIELD_5==1}}
				<tr>
					<td class="de_separator" colspan="3"><h2>{{$lang.categorization.category_divider_customization}}</h2></td>
				</tr>
			...
			<div class="dgf_advanced_filters">
				<div class="dgf_filter">
					<select name="se_status_id">
						<option value="">{{$lang.categorization.category_field_status}}...</option>
						<option value="1" {{if $smarty.session.save.$page_name.se_status_id=='1'}}selected{{/if}}>{{$lang.categorization.category_field_status_active}}</option>
						<option value="0" {{if $smarty.session.save.$page_name.se_status_id=='0'}}selected{{/if}}>{{$lang.categorization.category_field_status_disabled}}</option>
					</select>
				</div>
				<div class="dgf_filter">
					<div class="insight">
						...
						<input type="text" name="se_category_group" value="{{$smarty.session.save.$page_name.se_category_group}}" placeholder="{{$lang.categorization.category_field_group}}..."/>
					</div>
				</div>
				<div class="dgf_filter">
					<select name="se_field">
						<option value="">{{$lang.common.dg_filter_field}}...</option>
						<option value="empty/description" {{if $smarty.session.save.$page_name.se_field=="empty/description"}}selected{{/if}}>{{$lang.common.dg_filter_option_empty_field|replace:"%1%":$lang.categorization.category_field_description}}</option>
						<option value="empty/synonyms" {{if $smarty.session.save.$page_name.se_field=="empty/synonyms"}}selected{{/if}}>{{$lang.common.dg_filter_option_empty_field|replace:"%1%":$lang.categorization.category_field_synonyms}}</option>
						<option value="empty/group" {{if $smarty.session.save.$page_name.se_field=="empty/group"}}selected{{/if}}>{{$lang.common.dg_filter_option_empty_field|replace:"%1%":$lang.categorization.category_field_group}}</option>
						<option value="empty/screenshot1" {{if $smarty.session.save.$page_name.se_field=="empty/screenshot1"}}selected{{/if}}>{{$lang.common.dg_filter_option_empty_field|replace:"%1%":$lang.categorization.category_field_screenshot1}}</option>
						<option value="empty/screenshot2" {{if $smarty.session.save.$page_name.se_field=="empty/screenshot2"}}selected{{/if}}>{{$lang.common.dg_filter_option_empty_field|replace:"%1%":$lang.categorization.category_field_screenshot2}}</option>
						...
						{{section name="data" start="1" loop="6"}}
							...
							{{/if}}
						{{/section}}
						<option value="filled/description" {{if $smarty.session.save.$page_name.se_field=="filled/description"}}selected{{/if}}>{{$lang.common.dg_filter_option_non_empty_field|replace:"%1%":$lang.categorization.category_field_description}}</option>
						<option value="filled/synonyms" {{if $smarty.session.save.$page_name.se_field=="filled/synonyms"}}selected{{/if}}>{{$lang.common.dg_filter_option_non_empty_field|replace:"%1%":$lang.categorization.category_field_synonyms}}</option>
						<option value="filled/group" {{if $smarty.session.save.$page_name.se_field=="filled/group"}}selected{{/if}}>{{$lang.common.dg_filter_option_non_empty_field|replace:"%1%":$lang.categorization.category_field_group}}</option>
						<option value="filled/screenshot1" {{if $smarty.session.save.$page_name.se_field=="filled/screenshot1"}}selected{{/if}}>{{$lang.common.dg_filter_option_non_empty_field|replace:"%1%":$lang.categorization.category_field_screenshot1}}</option>
						<option value="filled/screenshot2" {{if $smarty.session.save.$page_name.se_field=="filled/screenshot2"}}selected{{/if}}>{{$lang.common.dg_filter_option_non_empty_field|replace:"%1%":$lang.categorization.category_field_screenshot2}}</option>
						{{section name="data" start="1" loop="11"}}
							{{assign var="custom_field_id" value="custom`$smarty.section.data.index`"}}
							{{assign var="custom_field_name_id" value="CATEGORY_FIELD_`$smarty.section.data.index`_NAME"}}
							{{assign var="custom_field_enable_id" value="ENABLE_CATEGORY_FIELD_`$smarty.section.data.index`"}}
