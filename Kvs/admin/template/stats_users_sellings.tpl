	...
	<form action="{{$page_name}}" method="get" class="form_dgf" name="{{$smarty.now}}">
		<div class="dgf">
			<div class="dgf_filter">
				<div class="drop">
					<i class="icon icon-action-groupby"></i><span>{{$lang.stats.users_purchases_filter_group_by}}</span>
					<ul>
						<li {{if $smarty.session.save.$page_name.se_group_by=='user'}}class="selected"{{/if}}><a href="{{$page_name}}?se_group_by=user">{{$lang.stats.users_purchases_filter_group_by_user}}</a></li>
						<li {{if $smarty.session.save.$page_name.se_group_by=='video'}}class="selected"{{/if}}><a href="{{$page_name}}?se_group_by=video">{{$lang.stats.users_purchases_filter_group_by_video}}</a></li>
						<li {{if $smarty.session.save.$page_name.se_group_by=='album'}}class="selected"{{/if}}><a href="{{$page_name}}?se_group_by=album">{{$lang.stats.users_purchases_filter_group_by_album}}</a></li>
						<li {{if $smarty.session.save.$page_name.se_group_by=='profile'}}class="selected"{{/if}}><a href="{{$page_name}}?se_group_by=profile">{{$lang.stats.users_purchases_filter_group_by_profile}}</a></li>
						<li {{if $smarty.session.save.$page_name.se_group_by=='dvd'}}class="selected"{{/if}}><a href="{{$page_name}}?se_group_by=dvd">{{$lang.stats.users_purchases_filter_group_by_dvd}}</a></li>
						<li {{if $smarty.session.save.$page_name.se_group_by=='log'}}class="selected"{{/if}}><a href="{{$page_name}}?se_group_by=log">{{$lang.stats.users_purchases_filter_group_by_full}}</a></li>
					</ul>
				</div>
			</div>
			<div class="dgf_reset">
			...
			<div class="dgf_advanced_filters">
				<div class="dgf_filter">
					<div class="insight">
						...
						<input type="text" name="se_user" value="{{$smarty.session.save.$page_name.se_user}}" placeholder="{{$lang.stats.users_purchases_field_user}}..."/>
					</div>
				</div>
				<div class="dgf_filter">
					<input type="text" name="se_reseller_code" value="{{$smarty.session.save.$page_name.se_reseller_code}}" placeholder="{{$lang.stats.users_purchases_field_reseller_code}}..."/>
				</div>
				<div class="dgf_filter">
