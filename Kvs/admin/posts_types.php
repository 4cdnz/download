...
grid_presets_start($grid_presets, $page_name, 'post_types');
...
$table_fields[] = array('id' => 'posts_amount', 'title' => $lang['posts']['post_type_field_posts_count'],  'is_default' => 1, 'type' => 'number', 'link' => 'posts.php?se_post_type_id=%id%', 'link_id' => 'post_type_id', 'permission' => 'posts|view', 'ifdisable_zero' => 1);
...
grid_presets_end($grid_presets, $page_name, 'post_types');
