...
grid_presets_start($grid_presets, $page_name, 'stats_users_transactions');
...
if ($list_grouping == "ip")
{
	$table_fields[] = array('id' => 'ip',           'title' => $lang['stats']['users_initial_transactions_field_ip'],      'is_default' => 1, 'type' => 'ip', 'filter_ids' => ['se_ip' => '@value']);
...
{
	$table_fields[] = array('id' => 'user',              'title' => $lang['stats']['users_initial_transactions_field_user'],          'is_default' => 1, 'type' => 'user', 'filter_ids' => ['se_user' => 'user']);
	$table_fields[] = array('id' => 'reseller_code',     'title' => $lang['stats']['users_initial_transactions_field_reseller_code'], 'is_default' => 0, 'type' => 'text', 'filter_ids' => ['se_reseller_code' => 'reseller_code']);
	$table_fields[] = array('id' => 'ip',                'title' => $lang['stats']['users_initial_transactions_field_ip'],            'is_default' => 1, 'type' => 'ip', 'filter_ids' => ['se_ip' => '@value']);
	$table_fields[] = array('id' => 'country_code',      'title' => $lang['stats']['users_initial_transactions_field_country'],       'is_default' => 1, 'type' => 'choice', 'values' => $list_country_values);
...
{
	if ($field['type'] != 'rename' && $field['type'] != 'thumb')
	{
		$sort_array[] = $field['id'];
...
grid_presets_end($grid_presets, $page_name, 'stats_users_transactions');
