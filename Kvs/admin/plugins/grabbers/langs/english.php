...
$lang['plugins']['grabbers']['field_grabber_type']                      = "Grabber type";
$lang['plugins']['grabbers']['field_grabber_type_videos']               = "Videos";
$lang['plugins']['grabbers']['field_grabber_type_albums']               = "Albums";
...
$lang['plugins']['grabbers']['field_upload_log']                        = "Last upload log";
...
$lang['plugins']['grabbers']['field_custom_grabber_security']           = "Ability to upload custom grabbers is disabled due to security considerations; for enabling it please add the following line into [kt|b]/admin/include/setup.php[/kt|b] file: [kt|br] \$config['allow_custom_grabbers'] = 'true';";
...
$lang['plugins']['grabbers']['field_ydl_path']                          = "Yt-dlp library";
$lang['plugins']['grabbers']['field_ydl_path_hint']                     = "Yt-dlp library is used to download videos for many grabbers, you can install it from [kt|b]https://github.com/yt-dlp/yt-dlp[/kt|b] [kt|br] The path is automatically detected from your system, but if you want to manually configure it, you can add the following line in [kt|b]/admin/include/setup.php[/kt|b] file: [kt|br] \$config['ydl_path'] = \"/custom/path/to/ydl\";";
$lang['plugins']['grabbers']['field_last_exec']                         = "Last executed";
$lang['plugins']['grabbers']['field_last_exec_none']                    = "none";
$lang['plugins']['grabbers']['field_last_exec_data']                    = "%1% seconds";
$lang['plugins']['grabbers']['field_next_exec']                         = "Next execution";
$lang['plugins']['grabbers']['field_next_exec_none']                    = "none";
$lang['plugins']['grabbers']['field_next_exec_running']                 = "running now...";
...
$lang['plugins']['grabbers']['field_data_release_year']                 = "Release year";
$lang['plugins']['grabbers']['field_data_custom']                       = "Custom fields";
$lang['plugins']['grabbers']['field_data_user']                         = "Author (user)";
$lang['plugins']['grabbers']['field_data_comments']                     = "Comments";
...
$lang['plugins']['grabbers']['field_autogenerate_users']                = "Users";
$lang['plugins']['grabbers']['field_autogenerate_users_enabled']        = "import from fake users";
$lang['plugins']['grabbers']['field_autogenerate_users_hint']           = "randomly generate usernames from a 8 million username database";
$lang['plugins']['grabbers']['field_import_deleted_content']            = "Deleted content";
$lang['plugins']['grabbers']['field_import_deleted_content_enabled']    = "re-import content that was deleted";
$lang['plugins']['grabbers']['field_import_deleted_content_hint']       = "whether you want this grabber to re-import content that was previously imported and then deleted from KVS";
...
$lang['plugins']['grabbers']['field_download_format_group']             = "Video format group";
$lang['plugins']['grabbers']['field_download_format_group_auto']        = "Auto-select";
$lang['plugins']['grabbers']['field_truncate_duration']                 = "Cut intro and postroll";
$lang['plugins']['grabbers']['field_truncate_duration_start']           = "from beginning";
$lang['plugins']['grabbers']['field_truncate_duration_end']             = "from end";
$lang['plugins']['grabbers']['field_truncate_duration_hint']            = "you can specify how many seconds KVS should cut from beginning and end of each imported video from this grabber";
...
$lang['plugins']['grabbers']['field_terminology_filter_hint']           = "specify list of words or phrases that you don't want to import; all content that have any of these words or phrases in title, categories, tags, models or content source, will be skipped [kt|br] comma or new line separated list of words or phrases; use [kt|b]*[/kt|b] to indicate partial word matching, otherwise only standalone words will be considered [kt|br] also supports regex patterns that comply with PCRE syntax (http://php.net/manual/en/reference.pcre.pattern.syntax.php), for example [kt|b]|foo[^0-9]+|iu[/kt|b]";
...
$lang['plugins']['grabbers']['field_autodelete_mode']                   = "Delete mode";
$lang['plugins']['grabbers']['field_autodelete_mode_delete']            = "Full deletion";
$lang['plugins']['grabbers']['field_autodelete_mode_mark']              = "Mark as deleted";
$lang['plugins']['grabbers']['field_autodelete_mode_hint']              = "if deleted content is only marked as deleted, such content will have all its files deleted, but will still be accessible via direct URLs and will render delete reason text; this mode is typically used for making sure your content URLs are not producing 404 errors after deleting them";
$lang['plugins']['grabbers']['field_autodelete_reason']                 = "Delete reason";
$lang['plugins']['grabbers']['field_autodelete_reason_hint']            = "specify text that should be rendered for content that is marked as deleted";
$lang['plugins']['grabbers']['field_autodelete_last_exec']              = "Last executed";
$lang['plugins']['grabbers']['field_autodelete_last_exec_info']         = "%1% seconds, %2% objects deleted";
...
$lang['plugins']['grabbers']['field_autopilot_interval']                = "Schedule";
$lang['plugins']['grabbers']['field_autopilot_interval_hint']           = "specify a number, if you want this grabber to be executed every N hours, or specify a list of time intervals like [kt|b]12:00-18:00, 23:00-24:00[/kt|b] if you want grabber to be executed at specific time only; please specify at least 1 hour long intervals, otherwise grabber may skip its execution";
...
$lang['plugins']['grabbers']['field_customize_user_agent']              = "Customize user-agent";
$lang['plugins']['grabbers']['field_customize_user_agent_hint']         = "specify your custom user-agent string to be used by this grabber, otherwise it will use KVS / Yt-dlp default one";
...
$lang['plugins']['grabbers']['field_admin_flag']                        = "Administrator's flag";
$lang['plugins']['grabbers']['field_admin_flag_hint']                   = "specify if all objects imported by this grabber should have specific administrator's flag; go to [kt|b]Categorization -> Flags[/kt|b] to enable flags that can be used in admin panel";
...
$lang['plugins']['grabbers']['error_formats_from_multiple_groups']      = "[kt|b]%1%[/kt|b]: please select video formats from the same group";
...
$lang['plugins']['grabbers']['error_ydl_path_invalid']                  = "[kt|b]%1%[/kt|b]: binary path is invalid: %2%";
...
$lang['plugins']['grabbers']['error_grabber_noydl']                     = "Yt-dlp library is not found (https://github.com/yt-dlp/yt-dlp)";
