...
$lang['plugins']['grabbers']['field_grabber_type']                      = "Тип граббера";
$lang['plugins']['grabbers']['field_grabber_type_videos']               = "Видео";
$lang['plugins']['grabbers']['field_grabber_type_albums']               = "Альбомы";
...
$lang['plugins']['grabbers']['field_upload_log']                        = "Лог последней загрузки";
...
$lang['plugins']['grabbers']['field_custom_grabber_security']           = "Возможность загружать свои грабберы выключена из соображений безопасности; для ее включения вам следует добавить в файл [kt|b]/admin/include/setup.php[/kt|b] такую строку: [kt|br] \$config['allow_custom_grabbers'] = 'true';";
...
$lang['plugins']['grabbers']['field_ydl_path']                          = "Библиотека yt-dlp";
$lang['plugins']['grabbers']['field_ydl_path_hint']                     = "Библиотека yt-dlp используется для скачивания видео во многих грабберах, информация о ее установке находится по адресу [kt|b]https://github.com/yt-dlp/yt-dlp[/kt|b] [kt|br] Путь к библиотеке определяется автоматически, но вы можете прописать другой путь с любыми опциями в файле [kt|b]/admin/include/setup.php[/kt|b]: [kt|br] \$config['ydl_path'] = \"/custom/path/to/ydl\";";
$lang['plugins']['grabbers']['field_last_exec']                         = "Последний запуск";
$lang['plugins']['grabbers']['field_last_exec_none']                    = "нет";
$lang['plugins']['grabbers']['field_last_exec_data']                    = "%1% секунд";
$lang['plugins']['grabbers']['field_next_exec']                         = "Следующий запуск";
$lang['plugins']['grabbers']['field_next_exec_none']                    = "нет";
$lang['plugins']['grabbers']['field_next_exec_running']                 = "работает сейчас...";
...
$lang['plugins']['grabbers']['field_data_release_year']                 = "Год выпуска";
$lang['plugins']['grabbers']['field_data_custom']                       = "Доп. поля";
$lang['plugins']['grabbers']['field_data_user']                         = "Автор (пользователь)";
$lang['plugins']['grabbers']['field_data_comments']                     = "Комментарии";
...
$lang['plugins']['grabbers']['field_autogenerate_users']                = "Пользователи";
$lang['plugins']['grabbers']['field_autogenerate_users_enabled']        = "импорт от фейковых пользователей";
$lang['plugins']['grabbers']['field_autogenerate_users_hint']           = "автоматическая генерация имен пользователей из 8 млн базы имен";
$lang['plugins']['grabbers']['field_import_deleted_content']            = "Удаленный контент";
$lang['plugins']['grabbers']['field_import_deleted_content_enabled']    = "импортировать повторно";
$lang['plugins']['grabbers']['field_import_deleted_content_hint']       = "хотите ли вы, чтобы граббер повторно добавлял контент, который был добавлен ранее и потом удален из KVS";
...
$lang['plugins']['grabbers']['field_download_format_group']             = "Группа форматов видео";
$lang['plugins']['grabbers']['field_download_format_group_auto']        = "Автовыбор";
$lang['plugins']['grabbers']['field_truncate_duration']                 = "Обрезать вступление и концовку";
$lang['plugins']['grabbers']['field_truncate_duration_start']           = "с начала";
$lang['plugins']['grabbers']['field_truncate_duration_end']             = "с конца";
$lang['plugins']['grabbers']['field_truncate_duration_hint']            = "вы можете указать сколько секунд следует обрезать с начала и с конца видео при импорте всех видео через этот граббер";
...
$lang['plugins']['grabbers']['field_customize_user_agent']              = "Кастомизация user-agentа";
$lang['plugins']['grabbers']['field_customize_user_agent_hint']         = "укажите свою строку user-agentа для использования этим граббером, иначе будет использоваться user-agent по умолчанию из KVS / Yt-dlp";
...
$lang['plugins']['grabbers']['field_autodelete_mode']                   = "Режим удаления";
$lang['plugins']['grabbers']['field_autodelete_mode_delete']            = "Полное удаление";
$lang['plugins']['grabbers']['field_autodelete_mode_mark']              = "Пометить как удаленный";
$lang['plugins']['grabbers']['field_autodelete_mode_hint']              = "если удаленный контент только помечаются как удаленный, по нему удаляются все его файлы, но адреса страниц продолжают оставаться доступными и отображают причину удаления; этот режим обычно используется для того, чтобы страницы удаляемого контента не выдавали 404 ошибок";
$lang['plugins']['grabbers']['field_autodelete_reason']                 = "Причина удаления";
$lang['plugins']['grabbers']['field_autodelete_reason_hint']            = "укажите текст, на который будет заменяться отображение контента, помеченного как удаленный";
$lang['plugins']['grabbers']['field_autodelete_last_exec']              = "Последний запуск";
$lang['plugins']['grabbers']['field_autodelete_last_exec_info']         = "%1% секунд, %2% объектов удалено";
...
$lang['plugins']['grabbers']['field_autopilot_interval']                = "Расписание";
$lang['plugins']['grabbers']['field_autopilot_interval_hint']           = "укажите целое число, если вы хотите чтобы граббер запускался каждые N часов, либо набор временных интервалов вида [kt|b]12:00-18:00, 23:00-24:00[/kt|b], если хотите чтобы граббер запускался в конкретные периоды дня; указывайте минимум часовые интервалы, иначе граббер может не успеть запуститься из-за работы другого граббера";
...
$lang['plugins']['grabbers']['field_admin_flag']                        = "Флаг администратора";
$lang['plugins']['grabbers']['field_admin_flag_hint']                   = "выберите флаг администратора, который вы хотите установить для всех объектов, импортируемых этим граббером; включить флаги для использования в панели администрирования можно в разделе [kt|b]Категоризация -> Флаги[/kt|b]";
...
$lang['plugins']['grabbers']['error_formats_from_multiple_groups']      = "[kt|b]%1%[/kt|b]: вы должны выбрать форматы видео из одной группы";
...
$lang['plugins']['grabbers']['error_ydl_path_invalid']                  = "[kt|b]%1%[/kt|b]: некорректный путь к библиотеке: %2%";
...
$lang['plugins']['grabbers']['error_grabber_noydl']                     = "Библиотека yt-dlp не найдена (https://github.com/yt-dlp/yt-dlp)";
